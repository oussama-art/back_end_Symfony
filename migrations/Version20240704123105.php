 ...
 */
final class Version20240704123105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE token (id INT NOT NULL, user_id INT NOT NULL, token_value TEXT NOT NULL, expired BOOLEAN NOT NULL, PRIMARY KEY(id))');
